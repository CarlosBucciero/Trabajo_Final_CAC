<%-- 
    Document   : socios
    Created on : 28 dic 2022, 17:56:07
    Author     : carlo
--%>
...
<html>
    ...
    <body style="background-color:#b3d9ff;">
        ...
        <h1 style="background-color:Tomato;" align="center"> Listado de Socios del GYM</h1>
        
        <div class="container">
            
            <div class="row">
                <a class="btn btn-primary col-4 m-4" > Agregar socios </a>
